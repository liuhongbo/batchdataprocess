...
aws cloudformation deploy --template-file ./batchdataprocess-deploy-template.yaml --stack-name batch-data-processor --capabilities CAPABILITY_IAM --parameter-overrides CompanyParameter=eagle
```
